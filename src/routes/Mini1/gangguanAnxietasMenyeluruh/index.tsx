...
function GangguanAnxietasMenyeluruh({
  ...
  const [h11, setH11] = useState("Iya");
  const [h21, setH21] = useState("Iya");
  const [h22, setH22] = useState("Iya");
  const [h23, setH23] = useState("Iya");
  const [h24, setH24] = useState("Iya");
  const [h25, setH25] = useState("Iya");
  const [h26, setH26] = useState("Iya");
  const [h27, setH27] = useState("Iya");
  const [h28, setH28] = useState("Iya");
  const [h29, setH29] = useState("Iya");
  const [h210, setH210] = useState("Iya");
  const [h211, setH211] = useState("Iya");
  const [h212, setH212] = useState("Iya");
  const [h213, setH213] = useState("Iya");
  const [h214, setH214] = useState("Iya");
  const [h215, setH215] = useState("Iya");
  const [h216, setH216] = useState("Iya");
  const [h217, setH217] = useState("Iya");
  const [h218, setH218] = useState("Iya");
  const [h219, setH219] = useState("Iya");
  const [h220, setH220] = useState("Iya");
  const [h221, setH221] = useState("Iya");
  const [h222, setH222] = useState("Iya");
