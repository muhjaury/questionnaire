...
function Agorafobia({ setIsDone = () => {} }: Agorafobia_Type) {
  ...
  const [d51, setD51] = useState("");
  const [d52, setD52] = useState("");
  const [d53, setD53] = useState("");
  const [d54, setD54] = useState("");
  const [d55, setD55] = useState("");
  const [d56, setD56] = useState("");
  const [d57, setD57] = useState("");
  const [d58, setD58] = useState("");
  const [d59, setD59] = useState("");
  const [d510, setD510] = useState("");
  const [d511, setD511] = useState("");
  const [d512, setD512] = useState("");
  const [d513, setD513] = useState("");
  const [d514, setD514] = useState("");
