...
function GangguanPanik({ setIsDone = () => {} }: GangguanPanik_Type) {
  ...
  const [e11, setE11] = useState("Iya");
  const [e21, setE21] = useState("Iya");
  const [e31, setE31] = useState("Iya");
  const [e32, setE32] = useState("Iya");
  const [e33, setE33] = useState("Iya");
  const [e34, setE34] = useState("Iya");
  const [e35, setE35] = useState("Iya");
  const [e36, setE36] = useState("Iya");
  const [e37, setE37] = useState("Iya");
  const [e38, setE38] = useState("Iya");
  const [e39, setE39] = useState("Iya");
  const [e310, setE310] = useState("Iya");
  const [e311, setE311] = useState("Iya");
  const [e312, setE312] = useState("Iya");
  const [e313, setE313] = useState("Iya");
  const [e314, setE314] = useState("Iya");
  const [e41, setE41] = useState("Iya");
